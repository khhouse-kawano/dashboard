...
⚠️ ⚠️ **ビルド済み**（2026-09-22 19:45）。

| ファイル | 確認したこと |
|---|---|
| ⚠️ **`build/static/js/main.2c7d6cc9.js`** | ⚠️ **`2.2.145` を含む。粗利額の丸めまで入ったビルド** |
| `build/static/css/main.7c10f266.css` | ⚠️ **v2.2.144 から変わっていない**（⚠️ それでも一緒に上げてよい） |
| `build/index.html` | ⚠️ **上の2つを参照している** |

⚠️⚠️ **古いビルドを使わないこと。**
⚠️ `main.ee94e56a.js`（18:14）… RankResale が SaaS 版のまま
⚠️ `main.c00289b2.js`（19:34）… ⚠️ **粗利額の丸めが入っていない**
