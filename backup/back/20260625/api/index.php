...
try {
    ...
    } elseif ($demand === "customer_campaign" && $authHeader === '4081Kokubu') {
        require_once __DIR__ . '/actions/customer_campaign.php';
    } elseif ($demand === "campaign_inquiry" && $authHeader === '4081Kokubu') {
        require_once __DIR__ . '/actions/campaign_inquiry.php';
    } elseif ($demand === "event_calendar" && $authHeader === '4081Kokubu') {
        require_once __DIR__ . '/actions/event_calendar.php';
    } elseif ($demand === "calendar_list" && $authHeader === '4081Kokubu') {
        require_once __DIR__ . '/actions/calendar_list.php';
    } elseif ($demand === "calender_response" && $authHeader === '4081Kokubu') {
        require_once __DIR__ . '/actions/calender_response.php';
    } elseif ($demand === "calendar_change" && $authHeader === '4081Kokubu') {
        require_once __DIR__ . '/actions/calendar_change.php';
    } elseif ($demand === "calendar_add" && $authHeader === '4081Kokubu') {
        require_once __DIR__ . '/actions/calendar_add.php';
    } elseif ($demand === "change_resale_performance" && $authHeader === '4081Kokubu') {
        require_once __DIR__ . '/actions/change_resale_performance.php';
    } elseif ($demand === "registered_estate" && $authHeader === '4081Kokubu') {
        require_once __DIR__ . '/actions/registered_estate.php';
    } elseif ($demand === "estate_list" && $authHeader === '4081Kokubu') {
        require_once __DIR__ . '/actions/estate_list.php';
    } elseif ($demand === "get_token" && $authHeader === '4081Kokubu') {
        require_once __DIR__ . '/actions/get_token.php';
    } elseif ($demand === "call_log_list" && $authHeader === '4081Kokubu') {
        require_once __DIR__ . '/actions/call_log_list.php';
    } elseif ($demand === "show_customer_interview_log" && $authHeader === '4081Kokubu') {
        require_once __DIR__ . '/actions/show_customer_interview_log.php';
    } elseif ($demand === "update_interview_log" && $authHeader === '4081Kokubu') {
        require_once __DIR__ . '/actions/update_interview_log.php';
    } elseif ($demand === "update_cancel_reason" && $authHeader === '4081Kokubu') {
        require_once __DIR__ . '/actions/update_cancel_reason.php';
    } elseif ($demand === "staff_count" && $authHeader === '4081Kokubu') {
        require_once __DIR__ . '/actions/staff_count.php';
    } elseif ($demand === "customer_interview_log" && $authHeader === '4081Kokubu') {
        require_once __DIR__ . '/actions/customer_interview_log.php';
    } elseif ($demand === "customer_rank" && $authHeader === '4081Kokubu') {
        require_once __DIR__ . '/actions/customer_rank.php';
    } elseif ($demand === "show_customer_interview_list" && $authHeader === '4081Kokubu') {
        require_once __DIR__ . '/actions/show_customer_interview_list.php';
    } elseif ($demand === "register_form" && $authHeader === '4081Kokubu') {
        require_once __DIR__ . '/actions/register_form.php';
    } elseif ($demand === "show_survey_list" && $authHeader === '4081Kokubu') {
        require_once __DIR__ . '/actions/show_survey_list.php';
    } elseif ($demand === "master_data_list" && $authHeader === '4081Kokubu') {
        require_once __DIR__ . '/actions/master_data_list.php';
    } elseif ($demand === "update_iceWorld" && $authHeader === '4081Kokubu') {
        require_once __DIR__ . '/actions/update_iceWorld.php';
    } elseif ($demand === "update_family_info" && $authHeader === '4081Kokubu') {
        require_once __DIR__ . '/actions/update_family_info.php';
    } elseif ($demand === "show_family_info" && $authHeader === '4081Kokubu') {
        require_once __DIR__ . '/actions/show_family_info.php';
    } elseif ($demand === "show_family_list" && $authHeader === '4081Kokubu') {
        require_once __DIR__ . '/actions/show_family_list.php';
    } elseif ($demand === "update_gift_date" && $authHeader === '4081Kokubu') {
        require_once __DIR__ . '/actions/update_gift_date.php';
    } elseif ($demand === "customer_update" && $authHeader === '4081Kokubu') {
        require_once __DIR__ . '/actions/customer_update.php';
    } elseif ($demand === "update_rank" && $authHeader === '4081Kokubu') {
        require_once __DIR__ . '/actions/update_rank.php';
    } elseif ($demand === "get_name" && $authHeader === '4081Kokubu') {
        require_once __DIR__ . '/actions/get_name.php';
    } elseif ($demand === "informationRoad" && $authHeader === '4081Kokubu') {
        require_once __DIR__ . '/actions/informationRoad.php';
    } elseif ($demand === "show_version" && $authHeader === '4081Kokubu') {
        require_once __DIR__ . '/actions/show_version.php';
    } elseif ($demand === "update_log" && $authHeader === '4081Kokubu') {
        require_once __DIR__ . '/actions/update_log.php';
    } elseif ($demand === "heartbeat" && $authHeader === '4081Kokubu') {
        require_once __DIR__ . '/actions/heartbeat.php';
    } elseif ($demand === "login_log" && $authHeader === '4081Kokubu') {
        require_once __DIR__ . '/actions/login_log.php';
    } elseif ($demand === "get_estate_info" && $authHeader === '4081Kokubu') {
        require_once __DIR__ . '/actions/get_estate_info.php';
    } elseif ($demand === "get_customer_estate" && $authHeader === '4081Kokubu') {
        require_once __DIR__ . '/actions/get_customer_estate.php';
    }
