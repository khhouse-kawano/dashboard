...
try {
    ...
    $sql = "INSERT INTO master_data_kaeru (" . implode(', ', $columns) . ") VALUES (" . implode(', ', $placeholders) . ")";
    $stmt = $pdo->prepare($sql);
    $stmt->execute($params);

    $updateSql = "UPDATE inquiry_customer_kaeru SET pg_id = ?, sync = 1 WHERE inquiry_id = ?";
