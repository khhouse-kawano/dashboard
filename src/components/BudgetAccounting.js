...
const Budget = () => {
    ...
    useEffect(() =>{
        const fetchData = async() =>{
            try {
                const response = await axios.post("/dashboard/api/shopListAccounting.php");
    ...
    useEffect(() =>{
        const fetchData = async() =>{
            try {
                const response = await axios.post("/dashboard/api/budgetAccounting.php");
    ...
    const brandArray =[ "KH", "DJH", "なごみ", "2L", "FH", "PG HOUSE", "かえる"];
