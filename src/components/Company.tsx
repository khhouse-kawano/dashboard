...
type Customer = { id: string, customer: string, contract: string, shop: string, staff: string, section: string, rank: string, status: string, rank_period: string };
                    ...
                    <Table bordered style={{ fontSize: '12px' }} className='company-table'>
                        <tbody className='align-middle'>
                            ...
                            <tr className='sticky-header next_top'>
                                ...
                                {monthPeriod.map(month => {
                                    const contractOrder = orderList.filter(o => dateFormate(o.contract).includes(dateFormate(month)));
                            ...
                            {divisionArray.map((division, divisionIndex) => {
                                ...
                                const orderProspectList = orderList.filter(o => o.status === '見込み' && (o.rank_period <= formattedThisMonth || !o.rank_period));
