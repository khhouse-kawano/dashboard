                    ...
                    <Table hover className="align-middle mb-0" style={{ minWidth: '1800px' }}>
                        ...
                        <tbody style={{ fontSize: '13px' }}>
                            ...
                            {newEntry && <tr className="table-primary border-bottom" style={{ backgroundColor: '#f0f7ff' }}>
                                ...
                                <td className="p-2">
                                    <BsForm.Select size="sm" value={newEntryData.brand} onChange={(e) => setNewEntryData(prev => ({ ...prev, brand: e.target.value }))} style={{ fontSize: '12px', cursor: 'pointer' }} disabled={isOrdinary}>
                                        {BRAND_OPTIONS.map(b => <option key={b} value={b}>{b}</option>)}
                                    </BsForm.Select>
                                </td>
                                ...
                                <td className="text-center">
                                    <div className="d-flex justify-content-center">
                                        <BsForm.Check type="switch" checked={newEntryData.show_key === "1"} onChange={(e) => setNewEntryData(prev => ({ ...prev, show_key: e.target.checked ? "1" : "0" }))} style={{ cursor: 'pointer' }} disabled={isOrdinary} />
                                    </div>
                                </td>
                            </tr>}
                                    ...
                                    <tr key={item.no ?? index} className="border-bottom" style={{ transition: 'background-color 0.15s ease' }}>
                                        ...
                                        <td className="p-2">
                                            <BsForm.Control
                                                ...
                                                className="fw-bold" style={{ fontSize: '12px' }} disabled={isOrdinary}
                                            />
                                        </td>
                                        ...
                                        <td className="p-2">
                                            <BsForm.Select
                                                ...
                                                style={{ fontSize: '12px', cursor: 'pointer' }} disabled={isOrdinary}
                                            >
                                                {BRAND_OPTIONS.map(b => <option key={b} value={b}>{b}</option>)}
                                            </BsForm.Select>
                                        </td>
                                        ...
                                        <td className="p-2">
                                            <BsForm.Control
                                                ...
                                                style={{ fontSize: '12px' }} disabled={isOrdinary}
                                            />
                                        </td>
