    ...
    useEffect(() => {
        ...
        if (id === 'new') {
            ...
            const fetchData = async () => {
                ...
                setOriginalPropertyList(response.data.property.map(p => p.property_name));
            };
            fetchData();
        } else {
            setSending(true)
    ...
    const handleSave = async () => {
        ...
        if (isAddInterview) {
            ...
            updatedMasterData = {
                ...information,
                [key]: interview.day,
                request: id === 'new' ? 'informationEdit_add_new_customer' : 'informationEditKaeru_edit_registered_customer'
            };
