...
const RankDev = () => {
    ...
    const [interviewLogList, setInterviewLogList] = useState<InterviewLog[]>([]);
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                ...
                const [customerResponse, shopResponse, staffResponse, contractResponse, contractExResponse, sectionResponse, interviewResponse] = await Promise.all([
                    ...
                    axios.post("https://khg-marketing.info/dashboard/api/", { demand: 'customer_interview_log' }, { headers })
                ]);
                                ...
                                <Modal.Body>
                                    <div className='row'>
                                        <div className='col p-2'>
                                            ...
                                            <Table striped style={{ fontSize: '12px' }} hover bordered>
                                                <thead>
                                                    <tr>
                                                        <td>店舗</td>
                                                        <td>担当営業</td>
