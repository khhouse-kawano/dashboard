...
const ListDev = () => {
    ...
    const inquiryFilter = (shopValue: string) => {
        return inquiryList.filter(c => (shopValue ? c.shop === shopValue : true) && c.inquiry_date.replace(/-/g, '/').includes(selectedMonth)).length;
    };
    ...
    const reserveFilter = (shopValue: string) => {
        return customerList.filter(c => (shopValue ? c.shop == shopValue : true) && c.reserve.replace(/-/g, '/').includes(selectedMonth)).length;
    };
