...
const MenuDev = ({ key, onReload }: Props) => {
    ...
    const categoryMapping = {
        'order': {
            label: '注文営業',
            class: 'text-white bg-primary rounded fw-bold px-2 py-0 ms-1'
        },
        'spec': {
            label: '建売営業',
            class: 'text-white bg-success rounded fw-bold px-2 py-0 ms-1'
        },
        'used': {
            label: '中古住宅',
            class: 'text-white bg-warning rounded fw-bold px-2 py-0 ms-1'
        }
    };
