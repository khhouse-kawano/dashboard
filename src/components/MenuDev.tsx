        ...
        <>
            ...
            <div className="d-md-flex flex-column p-2" style={{ height: '100vh', borderRight: '1px solid #D3D3D3' }}>
                <div className="menuLogo m-3 position-relative" onClick={() => navigate("/home", { state: { brand: brand, }, })}>
                    ...
                    <div style={{ fontSize: '10px', bottom: '-8px', right: '0' }} className="position-absolute">ver{version}</div>
                </div>
            ...
            {category === 'used' && <div className={`category_menu  mb-2 px-2  ${currentPath.includes("/customerTrendResale") ? "selected" : ""}`}
                ...
                <div className={`category_menu  mb-2 px-2  ${currentPath.includes("/log") ? "selected" : ""}`}
                    ...
                    利用ログ<span className="bg-primary text-white rounded ms-2" style={{ fontSize: '8px', padding: '1px 3px' }}>管理者専用</span>
                </div>
            ) : null} */}
            </div>
        </>
