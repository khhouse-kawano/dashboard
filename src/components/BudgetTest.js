...
// 開発用
import { budgetList } from './shopList.js';
            ...
            <Table striped bordered hover className='budget_table'>
                <thead className='sticky-header'> 
                    <tr className='sticky-header'>
                        <th className="sticky-column bg-success text-white">販促媒体</th>
                        <th className="bg-success text-white">合計</th>
                        {mediumList.map((medium, index) =><th key={index} className="bg-success text-white">{medium.medium}</th>)}
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <th className="sticky-column bg-success text-white">グループ全体</th>
                    ...
                    { brandArray.map((brand, index) =>
                        <tr key={index}>
                            <th className="sticky-column bg-success text-white">{brand}合計</th>
                    ...
                    {shopList.map((shop, index) =>
                        <tr key={index} className="bg-success text-white">
                            <th className="sticky-column bg-success text-white">{shop.shop}</th>
