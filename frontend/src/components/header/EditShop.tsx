                    ...
                    <Table hover className="align-middle mb-0" style={{ minWidth: '1300px' }}>
                        ...
                        <tbody style={{ fontSize: '13px' }}>
                            ...
                            {newShop && <tr className="table-primary border-bottom" style={{ backgroundColor: '#f0f7ff' }}>
                                <td><BsForm.Control size="sm" type="text" placeholder="ブランド" value={newShopData.brand} onChange={(e) => setNewShopData(prev => ({ ...prev, brand: e.target.value }))} style={{ fontSize: '12px' }} disabled={isOrdinary} /></td>
                                <td><BsForm.Control size="sm" type="text" placeholder="店舗名" value={newShopData.shop} onChange={(e) => setNewShopData(prev => ({ ...prev, shop: e.target.value }))} style={{ fontSize: '12px' }} className="fw-bold" disabled={isOrdinary} /></td>
                                <td><BsForm.Control size="sm" type="text" placeholder="事業部" value={newShopData.division} onChange={(e) => setNewShopData(prev => ({ ...prev, division: e.target.value }))} style={{ fontSize: '12px' }} disabled={isOrdinary} /></td>
                                <td><BsForm.Control size="sm" type="text" placeholder="セクション" value={newShopData.section} onChange={(e) => setNewShopData(prev => ({ ...prev, section: e.target.value }))} style={{ fontSize: '12px' }} disabled={isOrdinary} /></td>
                                <td><BsForm.Control size="sm" type="text" placeholder="エリア" value={newShopData.area} onChange={(e) => setNewShopData(prev => ({ ...prev, area: e.target.value }))} style={{ fontSize: '12px' }} disabled={isOrdinary} /></td>
                                {/* 新規トグル群 */}
                                <td className="text-center"><div className="d-flex justify-content-center"><BsForm.Check type="switch" checked={newShopData.show_flag === "1"} onChange={(e) => setNewShopData(prev => ({ ...prev, show_flag: e.target.checked ? "1" : "0" }))} style={{ cursor: 'pointer' }} disabled={isOrdinary} /></div></td>
                                <td className="text-center"><div className="d-flex justify-content-center"><BsForm.Check type="switch" checked={newShopData.report_flag === "1"} onChange={(e) => setNewShopData(prev => ({ ...prev, report_flag: e.target.checked ? "1" : "0" }))} style={{ cursor: 'pointer' }} disabled={isOrdinary} /></div></td>
                                <td className="text-center"><div className="d-flex justify-content-center"><BsForm.Check type="switch" checked={newShopData.multi === "1"} onChange={(e) => setNewShopData(prev => ({ ...prev, multi: e.target.checked ? "1" : "0" }))} style={{ cursor: 'pointer' }} disabled={isOrdinary} /></div></td>
                            </tr>}
